                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-outline-danger delete-permission" data-id="{{ $permission->id }}"><i class="fa fa-trash" aria-hidden="true"></i></button>
                        </form>
                        <script>
                            $(document).on('click', '.delete-permission', function(e) {
                                ...
                                var id = $(this).data('id');
                                Swal.fire({
                                    title: '¿Estás seguro de borrar este permiso?',
